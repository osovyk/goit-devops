...
```bash
# Set your ECR URL in values.yaml or pass via --set:
...
and Elastic IP all incur AWS charges. Always run `terraform destroy` after testing.
...
with your AWS account ID, or pass via:
